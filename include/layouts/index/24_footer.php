<footer id="footer" class="bg_fff footer">
    <div class="wap footerLxn">
        <div class="d_flex j_between row footerLxnFx">
            ...
            <nav class="pc_only navFooter">
                <ul class="d_flex j_between row ulNavFooter">
                    ...
                    <li class="liNavFooter liNavFooter02">
    ...
    <div class="d_flex j_between ali_center pcFixedBtnFx">
        <ul class="ctaPcFixedBtnFxc">
            <li class="liCtaPcFixedBtnFxc">
                <a class="undernone bg_669B40 fw_500 d_flex j_center ali_center btnCtaPcFixedBtnFxc" href="mail">
