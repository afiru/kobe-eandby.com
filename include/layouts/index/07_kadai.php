<div id="komarigoto" class="kadai">
    <div class="wap kadaiLxn">
        <section class="secKadai">
            ...
            <ul class="d_flex j_between row ulKadai">
                <li class="d_flex j_center ali_center bg_F6F6F6 cl_1D1D1F liKadai">
                    <p class="cl_1D1D1F txtset fw_500 txtLiKadai">
                        海外で商品を売りたいが、<br>何から始めればいいか分からない
                    </p>
                </li>
                <li class="d_flex j_center ali_center bg_F6F6F6 cl_1D1D1F liKadai">
                    <p class="cl_1D1D1F txtset fw_500 txtLiKadai">
                ...
                <li class="d_flex j_center ali_center bg_F6F6F6 cl_1D1D1F liKadai">
                    <p class="cl_1D1D1F txtset fw_500 txtLiKadai">
                        海外で組織をつくり<br>人を動かすことができるか不安
                    </p>
                </li>
                <li class="d_flex j_center ali_center bg_F6F6F6 cl_1D1D1F liKadai">
                    <p class="cl_1D1D1F txtset fw_500 txtLiKadai">
                        コンサルを入れたが、<br>現場が動かなかった
                    </p>
                </li>
                <li class="d_flex j_center ali_center bg_F6F6F6 cl_1D1D1F liKadai">
                    <p class="cl_1D1D1F txtset fw_500 txtLiKadai">
                        海外で通用するスキル・語学を<br>実践的に身につけたいが学ぶ場がない
                    </p>
                </li>
                <li class="d_flex j_center ali_center bg_F6F6F6 cl_1D1D1F liKadai">
                    <p class="cl_1D1D1F txtset fw_500 txtLiKadai">
                        組織のKPIが<br>「願望」で止まっている
                    </p>
                </li>
            </ul>

            <h2 class="t_center cl_1D1D1F fw_500 txtset h2KadaiCta">
                「頑張っているのに、なぜか結果が出ない」<br>それが一番つらい。
            </h2>

            <p class="t_center cl_2C2C2C fw_400 txtset txtKadaiCta">
                まずは、 整理されていない話からで構いません。<br>もちろん、国内の事業もご相談ください。
            </p>
