        ...
        <div class="d_flex j_between row visionFx">
            <section class="secVision">
                ...
                <p class="cl_1D1D1F fw_400 txtset txtVision">
                    世界とのつながりから生まれる新たな視点や可能性を、<br>
                    確かな価値として社会へ還元していきます。<br>
                    驚きは一瞬の刺激ではなく、未来を変える力になる、<br>
                ...
                <ul class="ulVision">
                    <li class="liVision">
                        <h5 class="cl_A2A2A2 plus fw_500 txtset h5Vision">01.PROFESSIONAL</h5>
                        <p class="cl_1D1D1F fw_400 txtset txtLiVison">企業の成長を導くプロフェッショナルな知見の提供</p>
                    </li>
                    <li class="liVision">
                        <h5 class="cl_A2A2A2 plus fw_500 txtset h5Vision">02.CULTURAL EXCHANGE</h5>
                        <p class="cl_1D1D1F fw_400 txtset txtLiVison">嗜好品を通じた国際文化交流の促進</p>
                    </li>
                    <li class="liVision">
                        <h5 class="cl_A2A2A2 plus fw_500 txtset h5Vision">03.APPROACH</h5>
                        <p class="cl_1D1D1F fw_400 txtset txtLiVison">環境・社会課題に対する創造的なアプローチの実践</p>
                    </li>
                    <li class="liVision">
                        <h5 class="cl_A2A2A2 plus fw_500 txtset h5Vision">04.EDUCATION</h5>
                        <p class="cl_1D1D1F fw_400 txtset txtLiVison">国や言語の壁を越えた教育機会の創出</p>
                    </li>
                </ul>
            </section>


            <div class="pore photoVisionlxn">
                <figure class="photoVision">
                    <picture>
                        <source media="(min-width: 768px)" srcset="img/photoVisionPc.png">
                        <!--PC画像-->
                        <source media="(max-width: 767px)" srcset="img/photoVisionSp.png">
